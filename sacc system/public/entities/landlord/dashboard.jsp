        ...
        <ul class="navbar-nav bg-gradient-success dashboard sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.jsp">
                <div class="sidebar-brand-icon">
                    <img src="../../images/tcfl-logo.png" alt="logo" class="logo"> </div>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="dashboard.jsp">
                    <i class="fas fa-fw fa-tachometer-alt iconsDashboard"></i><span>Landlord Dashboard</span></a>
            </li>
            <!-- Divider -->
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item collapseHover" href="../../entities/landlord/property/register-property.jsp">Register Property</a>
                        <a class="collapse-item collapseHover" href="../../entities/landlord/property/add-room.jsp">Add Room</a>
                        <a class="collapse-item collapseHover" href="../../entities/landlord/property/remove-room.jsp">Remove Room</a>
                        <a class="collapse-item collapseHover" href="../../entities/landlord/property/remove-property.jsp">Remove Property</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="feesPayment" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item collapseHover" href="../../payment_mngr/payment-conf.jsp">Transact Payment</a>
                        <a class="collapse-item collapseHover" href="../../404.jsp">Income Reports</a>
                    </div>
                </div>
            </li>
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="../landlord/email/report.jsp">
            ...
            <div id="content">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        ...
                                        <span class="font-weight-bold"> $290.29 has been deposited into your account!
                                        </span>
                                        </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="#">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                PROPERTIES</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><span id="properties">1</span></div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <!-- Earnings (Monthly) Card Example -->
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-success cardBorderPaid shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><span id="paid">3</span></div>
                                                </div>
                                                <div class="col">
                                        ...
                                        <div class="col-auto">
                                            <i class="fas fa-2x text-gray-300 iconPaid"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!-- 
    ...
    <script src="../../assets/js/plugins/chart-pie-demo.js"></script>
    <script src="../../assets/js/plugins/landlord-barchart.js"></script>
    <script src="../../assets/js/plugins/chart-area-demo.js"></script>
