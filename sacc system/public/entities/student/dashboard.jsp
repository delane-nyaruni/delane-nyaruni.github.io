        ...
        <ul class="navbar-nav bg-gradient-success dashboard sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="dashboard.jsp">
                    <i class="fas fa-fw fa-tachometer-alt iconsDashboard"></i><span>Student Dashboard</span></a>
            </li>
            <!-- Divider -->
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item collapseHover" href="../../entities/student/accomodation.jsp">Find Property</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="../student/email/report.jsp">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        ...
                                        <span class="font-weight-bold  "> Balance account.
                                        </span>
                                        </div>
                                </a>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                ACCOMMODATIONS</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><span id="accomododations">1</span></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                MONTHS-LEFT</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><span id="rooms">2</span></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-2x text-gray-300 iconBoys"></i>
                                        </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                                total SHARING</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><span id="totalTenants">1</span></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><span id="paid">210</span></div>
                                                </div>
                                                <div class="col">
                                ...
                                <div class="col-lg-12 col-md-100">
                                    <div class="p-5">
                                        ...
                                        <form class="user">
                                            ...
                                            <a href="../index.jsp" class="btn btn-primary btn-user btn-block transparent">
                                                Login
                                            </a>
                                        </form>
                                    </div>
